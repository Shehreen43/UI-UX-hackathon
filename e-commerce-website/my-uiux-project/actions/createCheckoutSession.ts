...
// //   address: z.string(),          // Added missing fields
// //   city: z.string(),             // Added missing fields
// //   firstName: z.string(),        // Added missing fields
// //   lastName: z.string(),         // Added missing fields
// //   phone: z.string(),            // Added missing fields
// //   totalAmount: z.number(),      // Added missing fields
// //   zipcode: z.string(),          // Added missing fields
// // });
...
export async function createCheckoutSession(
  ...
  try {
    ...
    // Save the session data to Sanity
    await client.create({
      _type: "checkout_session", // Assuming your document type is "checkout_session"
      customer: customerId,
      customer_creation: customerId ? undefined : "always",
      customer_email: !customerId ? metadata.customerEmail : undefined,
      metadata,
    ...
    return session.url; // This is the URL from Stripe, not from Sanity
  } catch (error) {
    console.error("Error creating checkout session:", error);
    throw error;
  }
