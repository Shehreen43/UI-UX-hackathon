...
// import { useAuth } from "@clerk/nextjs"; // ✅ Use useAuth() in Client Components
...
//                 <div className="p-4 sm:6 border-b border-gray-200">
...
//                   <p className="text-sm font-semibold text-gray-600 mb-3 sm:mb-4">Order Item</p>
//                   <div className="space-y-3 sm:space-y-4">
//                     {order.products?.map((product) => (
//                       <div key={product.product?.name} className="flex flex-row sm:items-center sm:justify-between gap-3 py-2 border-b last:border-b-0">
//                         <div className="flex items-center gap-3 sm:gap-4">
//                           {product.product?.image && (
//                             <div className="relative h-14 w-14 sm:h-16 sm:w-16 flex-shrink-0 rounded-md overflow-hidden">
//                               <Image
//                                 src={imageUrl(product.product.image)?.url() ?? "/fallback-image.jpg"}
...
//                           )}
//                           <div>
//                             <p className="font-semibold text-sm sm:text-base">{product.product?.name}</p>
                ...
                <div>
                  <div className="flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-center">
                    <div className="flex items-center">
                      <span className="text-sm text mr-2">Status:</span>
                      <span
