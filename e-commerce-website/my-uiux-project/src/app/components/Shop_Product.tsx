...
export const Shop_Product = () => {
  return (
    <div className="bg-white w-full overflow-hidden max-w-screen-2xl mx-auto my-10  px-20">
         {/* Card Grid MD screen ... */}
              <div className="w-full hidden md:grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mt-6">
            ...
            {/* Card Grid Mobile screen */}
            <div className="w-full grid grid-cols-1 md:hidden gap-6 mt-6">
                {productMobile.map((product) => (
                  <div key={product.id} className="flex flex-col">
                    <div className="min-w-[239px] max-h-[427px] w-full">
                      <Image
                        src={product.url}
