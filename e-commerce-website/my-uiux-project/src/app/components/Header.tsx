...
const Navbar = () => {
  ...
  return (
    <div className="w-full bg-white sticky top-0 z-50 shadow-md max-w-screen-2xl mx-auto overflow-hidden">
      ...
      {/* Navbar */}
      <div className="w-full flex gap-5 justify-between items-center px-4 md:px-8 lg:px-16 py-2">
        {/* page */}
        <div
        ...
        {/* left */}
        <div className="md:flex hidden md:w-full md:justify-center md:items-center gap-4 text-prim_blue">
          ...
          <div className="w-full flex justify-end">
            ...
            >
              ...
              <span className="absolute -top-2 -right-2 text-blue-400 rounded-full w-5 h-5 flex items-center justify-center text-xs">
                {/* {itemCount} */}
              </span>
            </Link>
             </div> 
